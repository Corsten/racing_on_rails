...
class Person < ApplicationRecord
  ...
  def team_name=(value)
    if value.blank? || value == "N/A"
      ...
      self.team = Team.find_by(name_or_alias: value)
      self.team = Team.new(name: value) unless team
    end
  end
  ...
  def category(discipline)
    category_discipline = if discipline.is_a?(String)
                            Discipline[discipline]
                          else
                            discipline
                          end

    case category_discipline
  ...
  def find_associated_records
    if team && team.new_record?
      if team.name.blank? || team.name == "N/A"
        ...
        existing_team = Team.find_by(name_or_alias: team.name)
