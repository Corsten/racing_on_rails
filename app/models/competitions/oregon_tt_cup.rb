module Competitions
  ...
  class OregonTTCup < Competition
    ...
    # OR TT Cup splits and combines source races to match age groups. Prevent duplicates by exact age group matches.
    def source_results_query(race)
      super
        .where(bar: true)
        .where("categories.ages_begin" => race.category.ages_begin)
        .where("categories.ages_end" => race.category.ages_end)
